...
function i18n_dict(): array
{
    return [
        'en' => [
            ...
            'login.email.label' => 'Official email',
            'login.email.placeholder' => 'name@example.com',
            'login.password.label' => 'Password',
            'login.password.placeholder' => 'Enter your password',
            'login.password.helper' => 'Minimum 9 characters; keep your credentials confidential.',
        ...
        'ne' => [
            ...
            'login.email.label' => 'आधिकारिक इमेल',
            'login.email.placeholder' => 'name@example.com',
            'login.password.label' => 'पासवर्ड',
            'login.password.placeholder' => 'पासवर्ड प्रविष्ट गर्नुहोस्',
            'login.password.helper' => 'कम्तीमा ९ क्यारेक्टर; आफ्नो प्रमाणीकरण सुरक्षित राख्नुहोस्।',
